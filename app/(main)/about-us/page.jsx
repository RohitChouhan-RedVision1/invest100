...
import Image from "next/image";
  ...
  const AboutUsPage = async () => {
    ...
    return (
      <div>
        <div>
          <div className="container mx-auto px-4 lg:px-32 py-36">
      ...
      {TeamsSection.map((member, index) => (
        <div key={index} className="mb-8 flex flex-col items-center md:items-start p-6 rounded-lg">
          ...
          <div className="md:pl-8 mt-6 md:mt-6">
            ...
            <h3 className="text-xl text-gray-600 text-center md:text-left">{member.designation}, Omnicompounding Enterprises</h3>
