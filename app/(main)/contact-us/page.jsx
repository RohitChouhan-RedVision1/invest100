    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-36">
      ...
      <div className="flex flex-col  gap-4 overflow-hidden rounded-lg mb-8">
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full justify-center items-center text-center">
          <div className="bg-[var(--rv-primary)] text-white p-8 rounded-2xl shadow-md w-full md:w-1/2 flex flex-col items-center justify-center">
        ...
        <div className="bg-[var(--rv-primary)] text-white p-8 rounded-2xl shadow-md flex flex-col items-center justify-center text-center w-full">
          <MapPin className="mb-2" size={24} />
          <h3 className="text-lg font-medium mb-6">Reach Us</h3>
