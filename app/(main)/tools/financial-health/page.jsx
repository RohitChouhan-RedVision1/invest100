...
const FinancialHealthPage = () => {
  ...
  const handleAnswerSelect = (mark) => {
    ...
    const answerText = mark === 1 ? "Yes" : "No"; // ✅ add Yes/No

    const newAnswer = {
      question: questions[currentQuestionIndex].question,
      selectedAnswerMarks: mark,
      selectedAnswerText: answerText, // ✅ FIXED
    };
...
${emailContent},`,
              ...
              <FormItem>
                <FormControl>
                  <textarea
                    placeholder="Message"
                    {...field}
                    className="w-full border border-gray-500 p-1 rounded bg-white px-3 py-2"
                    aria-label="Message"
                  />
                </FormControl>
                <FormMessage />
  ...
  return (
   ...
   <RvBreadcrumbs
                maintitle="Tools"
                lastTitle2='Financial Health'
            />
      {/* <InnerBanner pageName={"Financial health"} /> */}
      <div className="flex flex-col bg-cover bg-center relative section">
        ...
        <div className="main-section">
          <div className="max-w-screen-xl mx-auto px-4">
            <div  className={`flex flex-col  justify-center  text-center relative space-y-6 self-center`}>
                ...
                {!isStart ? (
                  ...
                  <div className="">
                    <div className="grid lg:grid-cols-2 gap-5">
                      <div className="">
                        <Image
                          src={"/images/financial-health.webp"}
                          width={900}
                          height={200}
                          alt="Image"
                      ...
                      <div className="flex flex-col items-center text-center space-y-6 self-center">
                        {/* 🎯 RESULT CARD */}
                        <div
                          className={`p-8 rounded-2xl shadow-2xl w-full max-w-md bg-[var(--rv-primary)]`}
                        >
                        ...
                        <Link
                          href={"#showfunds"}
                          id="showfunds"
                          className="showfunds btn btn-primary"
                        >
                          Show Funds
                        </Link>
                      </div>
            ...
            <div className={`${styles.mainPage}`}>
              <div className={`${styles.rvcards}`}>
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="mt-5 flex items-center justify-center gap-2">
                      <button
                        className={`btn vl-btn1  ${
                          selectedAnswer === 1
                            ? "bg-[var(--rv-secondary)] text-white"
                            : "bg-[var(--rv-primary)] text-black"
                        }`}
              ...
              {isQuizCompleted && (
                <div
                  id="showfunds"
                  className="bg-white/10 backdrop-blur-xl lg:px-8 lg:py-8 rounded-2xl shadow-xl border border-white/20 "
                >
