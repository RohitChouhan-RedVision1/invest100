        ...
        <div className="md:w-1/2">
          ...
          <ul className="mt-4 space-y-2 text-gray-700 text-lg">
            <li className="flex gap-2">
              <IoMdCheckmarkCircleOutline className="text-3xl text-[#0E314D]" />
        ...
        <div className="md:w-1/2 border border-[#C59F4A] rounded-lg p-6">
          <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="bg-[#C59F4A] text-white sm:text-lg md:text-lg font-bold px-4 py-2 rounded-lg hover:bg-[#a07d3e] transition-all w-[50%] cursor-pointer flex justify-center items-center mx-auto"
            >
